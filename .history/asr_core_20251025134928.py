...
# -*- coding: utf-8 -*-
"""
语音识别核心模块 - 阿里云DashScope ASR集成
=========================================

这是AI智能眼镜系统的语音识别核心，负责：
1. 实时语音识别：基于阿里云DashScope Paraformer模型
2. 语音活动检测：VAD（Voice Activity Detection）
3. 热词中断：支持"停下"、"别说了"等热词立即中断
4. 识别结果处理：partial和final结果的不同处理策略
...
技术特点：
- 基于阿里云DashScope Paraformer的高精度识别
- 支持中文语音识别
- 热词中断机制
- 异步处理架构
- 线程安全的全局状态管理
